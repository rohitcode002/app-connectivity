...
This script ONLY extracts data from PDFs → saves JSON + appends Excel.
It does NOT run any mapping layers (use extract_main.py for that).
...
def main() -> None:
    ...
    print("\n" + "=" * 64)
    print("  STANDALONE JCC EXTRACTION (no mapping)")
